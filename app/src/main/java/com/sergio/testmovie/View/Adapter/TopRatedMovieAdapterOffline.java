...
public class TopRatedMovieAdapterOffline extends RecyclerView.Adapter<TopRatedMovieAdapterOffline.MovieViewHolder> {


    private List<TopRatedMovie> movieList;
    private OnMovieClickCallback callback;


    public TopRatedMovieAdapterOffline(List<TopRatedMovie> movieList, OnMovieClickCallback callback){
    ...
    public MovieViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_movie,
                viewGroup, false);
        return new TopRatedMovieAdapterOffline.MovieViewHolder(view);
    }
