...
public class UpcomingAdapter extends RecyclerView.Adapter<UpcomingAdapter.MovieViewHolder>{
    ...
    public UpcomingAdapter(List<MovieRequest> movieList, OnMovieClickCallback callback){
    ...
    public MovieViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_movie,
                viewGroup, false);
        return new UpcomingAdapter.MovieViewHolder(view);
    }
                    ...
                    .into(new SimpleTarget<Bitmap>(100,100) {
                        ...
                        public void onResourceReady(@NonNull Bitmap resource, @Nullable Transition<? super Bitmap> transition) {
                            ...
                            AppExecutors.getInstance().getDiskIO().execute(() -> {
                                MovieApp.getDatabase().daoAccess().updateUpComingLocalImgPath(localImgPath, idMovie);
                            });
                        }
            ...
            Glide.with(itemView).asBitmap()
                    ...
                    .into(new SimpleTarget<Bitmap>(100,100) {
                        ...
                        public void onResourceReady(@NonNull Bitmap resource, @Nullable Transition<? super Bitmap> transition) {
                            ...
                            //Save to Room
                            AppExecutors.getInstance().getDiskIO().execute(() -> {
                                MovieApp.getDatabase().daoAccess().updateUpComingLocalBackDropPath(localBackDropPath, idMovie);
                            });
