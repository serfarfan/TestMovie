...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.MovieViewHolder>{
    ...
    public MovieAdapter(List<MovieRequest> movieList, OnMovieClickCallback callback) {
                     ...
                     .into(new SimpleTarget<Bitmap>(100,100) {
                         ...
                         public void onResourceReady(@NonNull Bitmap resource, @Nullable Transition<? super Bitmap> transition) {
                             ...
                             AppExecutors.getInstance().getDiskIO().execute(() -> {
                                 MovieApp.getDatabase().daoAccess().updateLocalImgPath(localImgPath, idMovie);
                             });
                         }
             ...
             Glide.with(itemView).asBitmap()
                     ...
                     .into(new SimpleTarget<Bitmap>(100,100) {
                         ...
                         public void onResourceReady(@NonNull Bitmap resource, @Nullable Transition<? super Bitmap> transition) {
                             ...
                             //Save to Room
                             AppExecutors.getInstance().getDiskIO().execute(() -> {
                                 MovieApp.getDatabase().daoAccess().updateLocalBackDropPath(localBackDropPath, idMovie);
                             });
